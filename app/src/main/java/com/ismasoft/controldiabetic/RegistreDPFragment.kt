 ...
 * Use the [RegistreDPFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RegistreDPFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_registre_d_p, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistreDPFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegistreDPFragment().apply {
